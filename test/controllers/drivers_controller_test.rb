...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { birth: @driver.birth, email: @driver.email, name: @driver.name } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { birth: @driver.birth, email: @driver.email, name: @driver.name } }
